...
"""
This still didn't work, need to change labels.flatten() to labels.cpu().flatten()
...
array([[7.4891357, 7.4891357, 7.4891357, ..., 7.4891357, 7.4891357,
        7.4891357],
       [4.212533 , 4.212533 , 4.212533 , ..., 4.212533 , 4.212533 ,
        4.212533 ],
       ...,
       [6.2382903, 6.2382903, 6.2382903, ..., 6.2382903, 6.2382903,
        6.2382903],
...
"""
In [19]: for name, value in pyro.get_param_store().items(): 
             print(name, pyro.param(name).cpu().detach().numpy().mean())                                                                                                                                                                                        
fc1w_mu 0.020490551
