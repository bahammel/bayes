...
"""
Output
auto_loc tensor([-2.2058,  0.3015, -1.8415, -0.1888,  9.1709], requires_grad=True)
#I assume this is [weight_1, bias_1, weight_2, bias_2, cross_correlation factor]

auto_scale tensor([0.1195, 0.0847, 0.1289, 0.0530, 0.0859], grad_fn=<AddBackward0>)
#This is uncertainity on above ???
