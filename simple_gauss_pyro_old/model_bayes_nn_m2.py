...
def model_fn(nn_model):
    ...
    def _model(x_data, y_data):
        ...
        fc1w_prior = Normal(torch.zeros(1,100), torch.ones(1,100)).to_event(1)
        fc1b_prior = Normal(10*torch.ones(1,100), 10*torch.ones(1,100)).to_event(1)

        outw_prior = Normal(torch.zeros(1,400), torch.ones(1,400)).to_event(1)
        outb_prior = Normal(10*torch.ones(1,400), 10*torch.ones(1,400)).to_event(1)
